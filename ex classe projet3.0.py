...
mercury = Planet("Mercury", 3e23, 2439000, 'gainsboro', 50597870700, 0,0,47362)
venus = Planet("Venus", 5e24, 6000000, 'floral white', 108000000000,0,0,35025)
earth = Planet("Earth", 6e24, 6400000, 'RoyalBlue4', 149597870700, 0, 0, 29783)
moon = Planet("Moon", 7e22, 1700000, 'grey', 149597870700+380000000, 0, 0, 29783+1022)
mars = Planet("Mars", 6e23, 3400000, 'coral', -230655000000,0,0,-24080)
jupiter = Planet("Jupiter", 1.9e27, 71000000, 'burlywood3', 780597870700, 0, 0, 13058)
saturn = Planet("Saturn", 568e24, 60268000, 'khaki2', 1475500000000, 0, 0, 9640)
